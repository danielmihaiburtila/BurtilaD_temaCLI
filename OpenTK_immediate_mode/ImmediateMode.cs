...
namespace OpenTK_immediate_mode
{
    class ImmediateMode : GameWindow
    {
        ...
        public ImmediateMode() : base(800, 600, new GraphicsMode(32, 24, 0, 8)) {
            VSync = VSyncMode.On; //sincronizare intre frame uri

            Console.WriteLine("OpenGl versiunea: " + GL.GetString(StringName.Version)); //apare numele aplicatiei
        ...
        protected override void OnLoad(EventArgs e) { ///se executa o data
            base.OnLoad(e);

            GL.ClearColor(Color.Blue); //culoarea de fundal
        ...
        /**Inițierea afișării și setarea viewport-ului grafic. Metoda este invocată la redimensionarea
           ...
           diferite). */
        protected override void OnResize(EventArgs e) { //atunci cand facem resize
            base.OnResize(e);
            ...
            Matrix4 lookat = Matrix4.LookAt(30, 30, 30, 0, 0, 0, 0, 1, 0); //unde se afla camera
        ...
        protected override void OnUpdateFrame(FrameEventArgs e) { //partea logica
        ...
        protected override void OnRenderFrame(FrameEventArgs e) { //partea de grafica
        ...
        static void Main(string[] args) {
            ...
            using (ImmediateMode example = new ImmediateMode()) {
                example.Run(30.0, 0.0);///de cate ori este executata functia de logica, al doilea 0 executa grafica cand poate, dupa cea de logica
                ///de 30/sec
            }
        }
    }
